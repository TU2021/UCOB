...
experiment_name="ucob_full_webshop_qwen3_1.7b"
skill_memory_file="outputs/dynamic_memory/${experiment_name}/webshop_reflections.json"
...
python3 -m verl.trainer.main_ucob \
    ...
    algorithm.ucob.skill_memory.skill_mapping_dir=skills/webshop \
    ...
    algorithm.ucob.skill_memory.max_trajectory_steps=15 \
    ...
    trainer.project_name='UCOB_webshop' \

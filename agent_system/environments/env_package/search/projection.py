...
def search_projection(actions: List[str], require_thinking: bool = False) -> Tuple[List[str], List[int]]:
    ...
    for i, action in enumerate(actions):
        ...
        if require_thinking and not _has_thinking_trace(original_action):
            valids[i] = 0

...
def _has_thinking_trace(text: str) -> bool:
    return text.find("<think>") != -1 and text.find("</think>") != -1


def alfworld_projection(actions: List[str], action_pools: List[List[str]], require_thinking: bool = False):
    """
    ...
    for i in range(len(actions)):
        ...
        if require_thinking and not _has_thinking_trace(original_str):
            valids[i] = 0

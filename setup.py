...
setup(
    ...
    url="https://github.com/TU2021/UCOB",
    license="Apache 2.0",
    author="Songjun Tu et al.",
    description="UCOB: Credit-Aware On-Policy Bidirectional Self-Distillation for Agentic Skill Learning",
